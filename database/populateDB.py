...
def populateDB(cursor, data):
	try:
		...
		#         	section_num_query = "SELECT section_id FROM Sections WHERE name = %(name)s"
		#         	cursor.execute(section_num_query,{'name':str(row['section_name'])})
		...
		#         	print('gened_id =',gened_id, " section_id = ",section_id)
